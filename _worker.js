...
// Variables
const rootDomain = "serveraby.web.id"; // Ganti dengan domain utama kalian
const serviceName = "inong"; // Ganti dengan nama workers kalian
const apiKey = "-OZqWDHoQBID3-w_RqnaSfEjfD4gcZX5Lnh5s78A"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "abydodik5@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "8f108e466e2710c1381beef272323d64"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "-OZqWDHoQBID3-w_RqnaSfEjfD4gcZX5Lnh5s78A"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
